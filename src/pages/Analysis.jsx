...
export default function Analysis() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const stepMap = { 20: 1, 45: 2, 70: 3, 90: 4, 100: 4 };
      const result = await predictMRI(file, (pct) => {
        setProgress(pct);
        setCurrentStep(stepMap[pct] ?? 0);
      });
        ...
        <div className="container-md">
          ...
          >
            ...
            <div>
              ...
              >
                AI-assisted brain tumor classification
              </p>
            </div>
          </div>
        </div>
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                >
                  ...
                  >
                    Upload a brain MRI image for AI-assisted classification. The
                    model will analyze the scan and provide a predicted class
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
                {[
                  { name: "Glioma", color: "var(--color-blue-600)" },
                  { name: "Meningioma", color: "var(--color-teal-600)" },
                  { name: "Pituitary Tumor", color: "var(--color-blue-600)" },
                  { name: "No Tumor", color: "var(--color-success)" },
                ].map((cls) => (
                  <div
                    key={cls.name}
                    style={{
              ...
              >
                <strong style={{ color: "#e2f0ff" }}>
                  Model:
                </strong>{" "}
                Hybrid CNN + Morphology (93% test accuracy)
              </div>
            </div>
